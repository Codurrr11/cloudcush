...
<header class="site-header">
  <div class="container navbar">
    ...
    <nav class="nav-col-left">
      <a href="javascript:void(0);" class="nav-link underline-hover">
        Diaper Trial & Subscribe<span class="badge-new">New</span>
      </a>
      ...
      <div class="discover-nav-wrapper">
        ...
        <div class="discover-menu" id="discoverMenu">
          <ul class="discover-links-list">
            ...
            <li><a href="javascript:void(0);">Parent Journal</a></li>
            <li><a href="javascript:void(0);">Diaper Guide</a></li>
            <li><a href="javascript:void(0);">Comfort Technology</a></li>
            <li><a href="javascript:void(0);">FAQs</a></li>
            <li><a href="javascript:void(0);">Community Stories</a></li>
          </ul>
        </div>
      </div>
      <div class="nav-icons">
...
<div class="mobile-nav-overlay" id="mobile-nav-menu">
  <nav class="mobile-menu-list">
    <div class="mobile-menu-item">
      <a href="javascript:void(0);" class="mobile-nav-link">Diaper Trial & Subscribe</a>
    </div>
